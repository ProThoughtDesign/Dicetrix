...
export class Preloader extends Scene {
  ...
  preload() {
    // Initialize visual effects (generates procedural textures)
  ...
  create() {
    ...
    // Transition to main menu with fade effect
  ...
  private createLoadingUI(): void {
    ...
    // Loading text
    this.loadingText = this.add.text(width / 2, height / 2 - 80, 'Loading Dicetrix...', {
